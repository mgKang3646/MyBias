...
public class MainViewUtil {
    ...
    public void createActorDetailViewAdapter(ActorDetailActivity actorDetailActivity){ mainViewAdapter = mainViewAdapterFactory.getActorDetailAdapter(mainView,actorDetailActivity); }
