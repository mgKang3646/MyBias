...
public class MainViewAdapterFactory {
    ...
    public MainViewAdapter getActorDetailAdapter(View view,ActorDetailActivity actorDetailActivity){ return new ActorDetailViewAdapter(view,actorDetailActivity); }
